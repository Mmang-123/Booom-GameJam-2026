...
namespace Mmang.PixelartRender
{
    public class MPointLight : MLight
    {
        ...
        private void OnDrawGizmosSelected()
        {
            ...
            UnityEditor.Handles.DrawWireDisc(transform.position, Vector3.forward, scaledRadius);
            ...
            float effectiveRadius = scaledRadius * Mathf.Max(0f, 1f - 0.5f / Mathf.Sqrt(Mathf.Max(Intensity, 0.0001f)));
