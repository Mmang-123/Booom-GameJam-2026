...
{
    public class PixelartBufferData : ContextItem
    {
        private Dictionary<EPixelartBuffer, TextureHandle> m_HandleMap = new();

        public void AddBuffer(EPixelartBuffer bufferType, TextureHandle textureHandle)
        {
            m_HandleMap.Add(bufferType, textureHandle);
        }

        public TextureHandle GetBuffer(EPixelartBuffer bufferType)
        {
            if (m_HandleMap.TryGetValue(bufferType, out var result))
            {
                return result;
            }
    ...
    public class RenderPass_OpaqueRendering : ScriptableRenderPass
    {
        private static readonly string s_PassTag = "Opaque Rendering";
        ...
        public RenderPass_OpaqueRendering(LayerMask layerMask, ShaderTagId shaderTag)
        {
